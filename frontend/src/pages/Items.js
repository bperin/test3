    ...
    return (
        <div>
            <form onSubmit={handleSearch} style={{ marginBottom: "20px" }}>
                <input type="text" value={searchInput} onChange={(e) => setSearchInput(e.target.value)} placeholder="Search items..." style={{ marginRight: "10px", padding: "5px" }} />
            ...
            {!loading && items.length === 0 && <p>No items found{searchQuery ? ` for "${searchQuery}"` : ""}.</p>}
                ...
                <>
                    ...
                    {pagination && (
                        <div style={{ marginTop: "20px", textAlign: "center" }}>
                            ...
                            <div>
                                <button onClick={() => handlePageChange(currentPage - 1)} disabled={!pagination.hasPrev || loading} style={{ marginRight: "10px" }}>
                                    Previous
                                </button>
                                ...
                                <button onClick={() => handlePageChange(currentPage + 1)} disabled={!pagination.hasNext || loading} style={{ marginLeft: "10px" }}>
                                    Next
                                </button>
                            </div>
                        </div>
